...
public class ISchoolShoesCategoryFragment1 extends Fragment {
    ...
    private void setUpPager() {
        ...
        if(res.moveToFirst()){
            do {
                adp.addFrag(new ISchoolShoesCategoryFragment(), res.getString(res.getColumnIndex(DBHandler.PM_Cat2)));
