...
public class IHawaiNEvaCategoryFragment1 extends Fragment {
    ...
    private void setUpPager() {
        ...
        if(res.moveToFirst()){
            do {
                adp.addFrag(new IHawaiNEvaCategoryFragment(), res.getString(res.getColumnIndex(DBHandler.PM_Cat2)));
