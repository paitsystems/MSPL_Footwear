...
public class FeedbackClass {
  public  String auto,crby,crdate,crtime,feedbk_type,article_no,invoice_no,qty,salesman_id,front_office,description,feed_img1,feed_img2,feed_img3,user_type,
    ...
    public String getFeedbk_type() {
        return feedbk_type;
    }

    public void setFeedbk_type(String feedbk_type) {
        this.feedbk_type = feedbk_type;
    }
    ...
    public void setFront_office(String front_office) {
        this.front_office = front_office;
    }
