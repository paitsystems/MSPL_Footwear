...
public class SchoolShoeCategoryGridAdapter extends BaseAdapter {
    ...
    public SchoolShoeCategoryGridAdapter(Context _context,List<GentsCategoryClass> _gents, String[] _drawId){
