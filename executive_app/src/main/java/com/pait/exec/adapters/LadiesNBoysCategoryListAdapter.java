...
public class LadiesNBoysCategoryListAdapter  extends BaseAdapter{

    private Context context;
    private List<GentsCategoryClass> gentCatList;
    private LayoutInflater inflater;

    public LadiesNBoysCategoryListAdapter(Context _context, List<GentsCategoryClass> _gentCatList){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null) {
            ...
            view = inflater.inflate(R.layout.list_item_sub_category_ladies, viewGroup, false);
