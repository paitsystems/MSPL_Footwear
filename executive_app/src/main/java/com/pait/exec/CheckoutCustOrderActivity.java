...
import com.pait.exec.adapters.CheckoutCustOrderAdapter;
            ...
            try {
                ...
                if (custOrderRes.moveToFirst()) {
                    do {
                        ...
                        data = data + prodId + "^" + sizeGroup + "^" + requiredSize + "^" + perPackQty + "^" + color + "^" + rate + "^" + mrp + "^" + qty + "^" + looseQty + "^" + actLooseQty + "^" + amount + "^" + loosePackTyp + "^" + gstAmt + "^" + totalAmt + "^" + pendingLooseQty + "^" + gstPer + "^" + CGSTAmt + "^" + SGSTAmt + "^" + IGSTAmt + "^" + CGSTPer + "^" + SGSTPer + "^" + CessPer + "^" + CESSAmt + ",";
