...
public class LocationServicePRM extends Service {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (Status.equalsIgnoreCase("OK")) {
                    ...
                    Log.d("Log",finalAddress);
                    Intent intent = new Intent();
                    intent.putExtra("loc", finalAddress);
                    intent.setAction("location_updated");
                    sendBroadcast(intent);
                    LocationServicePRM.this.stopSelf();
                }
            }catch (Exception e){
                Intent intent = new Intent();
                intent.putExtra("loc", "Not Available");
                intent.setAction("location_updated");
                sendBroadcast(intent);
                LocationServicePRM.this.stopSelf();
                e.printStackTrace();
