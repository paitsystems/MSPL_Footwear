...
import com.pait.cust.MainImagewiseSetwiseOrderActivity;
import com.pait.cust.constant.Constant;
import com.pait.cust.model.AreaMasterClass;
import com.pait.cust.model.BankBranchMasterClass;
import com.pait.cust.model.BankMasterClass;
import com.pait.cust.model.CheckoutCustOrderClass;
import com.pait.cust.model.CityMasterClass;
import com.pait.cust.model.CompanyMasterClass;
import com.pait.cust.model.CustomerDetailClass;
import com.pait.cust.model.CustomerOrderClass;
import com.pait.cust.model.DocumentMasterClass;
import com.pait.cust.model.EmployeeMasterClass;
import com.pait.cust.model.GSTMasterClass;
import com.pait.cust.model.HOMasterClass;
...
import com.pait.cust.model.TrackOrderDetailChangedClass;
...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public String getName(int id){
        String s = "";
        String str = "select "+CM_Name+" From "+Table_Customermaster+" where "+CM_RetailCustID+" = "+id;
        Constant.showLog(str);
    ...
    public Cursor getContactUsData(int hocode){
        String str = "";
        if(hocode==1){
            str = "select * from "+Table_CompanyMaster+" where "+Company_Initial+"='PAIT' and "+ Company_Id+"=1";
        }else if(hocode==12){
            str = "select * from "+Table_CompanyMaster+" where "+Company_Initial+"='PAIT2' and "+ Company_Id+"=12";
        }else if(hocode==13){
            str = "select * from "+Table_CompanyMaster+" where "+Company_Initial+"='PAIT3' and "+ Company_Id+"=13";
        }
        return getWritableDatabase().rawQuery(str,null);
    }
    ...
    public Cursor getImageSubCategory(String catName) {
        String str;
        if (MainImagewiseSetwiseOrderActivity.allOrNew == 0) {
            str = "select " + Table_ProductMaster + "." + PM_ProductID + "," + Table_ProductMaster + "." + PM_Cat2 + "," + Table_AllRequiredSizesDesigns + "." +
            ...
            str = "select " + Table_ProductMaster + "." + PM_ProductID + "," + Table_ProductMaster + "." + PM_Cat2 + "," + Table_AllRequiredSizesDesigns + "." +
                    ARSD_ImageName + " from " + Table_ProductMaster + "," + Table_AllRequiredSizesDesigns + " where " +
                    Table_ProductMaster + "." + PM_ProductID + ">=" + MainImagewiseSetwiseOrderActivity.product_id + " and " +
                    Table_ProductMaster + "." + PM_Cat9 + "='" + catName + "' and " + Table_AllRequiredSizesDesigns + "." + ARSD_Productid + "=" +
                    Table_ProductMaster + "." + PM_ProductID + " group by " + Table_ProductMaster + "." + PM_Cat2 + " order by " +
                    Table_ProductMaster + "." + PM_Cat2;
            Constant.showLog("getImageSubCategory :- " + str);
    ...
    public Cursor getImageSubCategory1(String catName, String subCatName) {
        String str;
        if (MainImagewiseSetwiseOrderActivity.allOrNew == 0) {
            str = "select " + Table_ProductMaster + "." + PM_ProductID + "," + Table_ProductMaster + "." + PM_Cat2 + ","
