package com.pait.cust.constant;
...
import com.pait.cust.braodcasts.AutoUpdateBroadcastReceiver;
...
public class Constant {
    ...
    //public static String ipaddress = "http://172.30.1.209/MSPLCDemo/service.svc";
    public static String ipaddress = "http://license.lnbinfotech.com/MSPLDemo/service.svc";
    ...
    public Constant() {
        if(connectionFlag == 0) {
            ipaddress = "http://license.lnbinfotech.com/MSPLDemo/service.svc";
