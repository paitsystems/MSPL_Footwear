...
import com.pait.cust.adapters.DispatchCenterListAdapter;
import com.pait.cust.adapters.ViewCustomerOrderAdapter;
...
public class ViewCustomerOrderActiviy extends AppCompatActivity implements View.OnClickListener,RecyclerViewToActivityInterface {
    ...
    private void init() {
        ...
        workingDispatchCenter.add("PAIT");
        workingDispatchCenter.add("PA1");
        workingDispatchCenter.add("PA2");
        workingDispatchCenter.add("PA3");
        workingDispatchCenter.add("PA4");
        workingDispatchCenter.add("PA5");
        workingDispatchCenter.add("PA6");
        workingDispatchCenter.add("PA7");
        workingDispatchCenter.add("PA8");
    }
