...
import com.pait.cust.ImageWiseAddToCartActivity;
...
public class ProductWiseImageRecyclerAdapter  extends RecyclerView.Adapter<ProductWiseImageRecyclerAdapter.ProductViewHolder> {
    ...
    public ProductWiseImageRecyclerAdapter(Context _context, List<ImagewiseAddToCartClass> _prodList) {
